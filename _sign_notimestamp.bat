...
copy /y "%EXE%" "F:\zcode\projects\tokenstep\TokenStep\TokenStep_v0.1.5.exe" >nul
copy /y "%SETUP%" "F:\zcode\projects\tokenstep\TokenStep\TokenStep_0.1.5_x64-setup.exe" >nul
echo === Done ===
endlocal
