...
VERSION="${TOKENSTEP_VERSION:-0.1.10}"
...
usage() {
  cat <<'USAGE'
Usage:
  TOKENSTEP_VERSION=0.1.10 CODE_SIGN_IDENTITY="Developer ID Application: Your Name (TEAMID)" ./script/package_release.sh [--notarize]
